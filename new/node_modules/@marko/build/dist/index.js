...
const configBuilder = exports.configBuilder = ({
  ...
  const babelLoader = targets => ({
    ...
    options: (0, _extends2.default)({}, babelConfig(targets), {
      cacheDirectory: true
    })
  });
  ...
  const getServerConfig = (fn = IDENTITY_FN) => fn((0, _extends2.default)({
    name: "Server",
    target: "async-node",
  ...
  const getBrowserConfig = (browser, fn = IDENTITY_FN) => fn((0, _extends2.default)({
