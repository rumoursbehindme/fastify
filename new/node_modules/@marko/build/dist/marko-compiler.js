...
const compiler = require(useAppModuleOrFallback(process.env.APP_DIR, "@marko/compiler"));
...
compiler.taglib.register(markoWebpackComponentsPath, require(markoWebpackComponentsPath));
